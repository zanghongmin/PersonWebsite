    ...
    <div class="container">
        <div class="col-md-8 header-left">
            <div class="col-sm-5 pro-pic">
                <img class="img-responsive" src="resume/images/p.jpg" alt=" "/>
            </div>
...
<div class="employment">
    <div class="container">
        ...
        <div class="col-md-6 employ-right">
            ...
            <p>设计整体测试框架及开发，从代码集成、打包、运行用例、到结果显示</p>
        </div>
        ...
        <div class="col-md-6 employ-right">
            ...
            <p>测试开发框架中使用jenkins进行集成操作，有时固有插件不能满足业务需要，需要进行插件开发 </p>
        </div>
        <div class="col-md-6 employ-left2">
        ...
        <div class="col-md-6 employ-right">
            ...
            <p>完成了360加固保后台管理平台等项目开发，从数据库到页面显示设计及开发</p>
        </div>
        <div class="col-md-6 employ-left2">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        ...
                        <p>测试结果页，展示运行结果. <a href="http://www.zanghongmin.top" target="_blank">项目介绍及源码</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        ...
                        <p>Atop项目管理页面，包括设备在线节点、任务启动、结果显示等. <a href="http://www.zanghongmin.top" target="_blank">项目介绍及源码</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        ...
                        <p>360加固保运营管理后台页面，用于管理留言回复、数据统计、黑白名单等 <a href="http://www.zanghongmin.top" target="_blank">项目介绍及源码</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        ...
                        <p>jemter插件页面，jmeter参数自定义循环、jemter参数加解密等 <a href="http://www.zanghongmin.top" target="_blank">项目介绍及源码</a>.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-content port-modal">
        ...
        <div class="container01">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        <img src="resume/images/p.jpg" class="img-responsive img-centered" alt="">
                    </div>
                </div>
            </div>
        </div>
