...
<div class="employment">
    <div class="container">
        ...
        <div class="col-md-6 employ-right">
            ...
            <p><a href="https://github.com/zanghongmin/AtopAutoAndriodTest" target="_blank">完成了360加固保后台管理平台等项目开发，从数据库到页面显示设计及开发...</a></p>
        </div>
        <div class="col-md-6 employ-left2">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        ...
                        <p><a href="https://github.com/zanghongmin/AtopAutoAndriodTest" target="_blank">360加固保运营管理后台页面，用于管理留言回复、数据统计、黑白名单等...</a></p>
                    </div>
                </div>
            </div>
        </div>
